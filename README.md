...
The project description is available in the project [document](doc/3dy4-project-2022.pdf). The unique constraints for each group for different modes of operation (i.e., custom sample rates) are available [here](doc/3dy4-constraints-group-51.pdf).
